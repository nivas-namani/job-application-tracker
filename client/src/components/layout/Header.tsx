import { CircleUserRound, FileText, LayoutDashboard, LogOut, Plus } from 'lucide-react';
import { useState, type ReactNode } from 'react';
import type { User } from '../../types';
import { Brand } from '../ui/Brand';

export type AppView = 'board' | 'resumes';
